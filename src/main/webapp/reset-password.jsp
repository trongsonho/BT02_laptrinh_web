...
<div class="form-container">
    ...
    <form action="${pageContext.request.contextPath}/reset-password" method="post">
        <div class="form-group">
            ...
            <input type="email" id="email" name="email" value="${not empty email ? email : sessionScope.resetEmail}" ${not empty email || not empty sessionScope.resetEmail ? 'readonly' : ''} required>
        </div>
        <div class="form-group">
