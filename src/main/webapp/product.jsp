...
<title>Danh sách sản phẩm - MyShop</title>

<style>
    .section-title { font-size: 24px; margin-bottom: 20px; border-bottom: 2px solid #0d6efd; padding-bottom: 10px; }
    .product-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 25px; }
    .product-card { background: white; border: 1px solid #dee2e6; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 5px rgba(0,0,0,0.05); transition: transform 0.2s; display: flex; flex-direction: column; }
    ...
    .product-quantity { font-size: 14px; color: #6c757d; margin-bottom: 10px; }
    .product-action { margin-top: auto; }
    .btn-detail { display: block; text-align: center; background-color: #0d6efd; color: white; padding: 10px 15px; border-radius: 4px; text-decoration: none; font-size: 14px; font-weight: bold; }
    ...
    .pagination a, .pagination span { padding: 8px 16px; border: 1px solid #dee2e6; border-radius: 4px; text-decoration: none; color: #0d6efd; font-weight: bold; }
    .pagination a:hover { background-color: #0d6efd; color: white; }
...
<div class="section-title fw-bold">
    <i class="bi bi-box-seam me-2"></i>Tất cả sản phẩm (Trang ${currentPage} / ${totalPages > 0 ? totalPages : 1})
</div>
